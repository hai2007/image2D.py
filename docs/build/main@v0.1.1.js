...
window.__etcpack__bundleSrc__['33']=function(){
    ...
    var styleElement = document.createElement('style');
var head = document.head || document.getElementsByTagName('head')[0];
styleElement.innerHTML = "\n [quickpaper] header[data-quickpaper-347ecaca]{\n\nborder-bottom: 1px solid #d6cdcd;\n\nline-height: 50px;\n\nposition: relative;\n\n}\n\n [quickpaper] header>*[data-quickpaper-347ecaca]{\n\ndisplay: inline-block;\n\nvertical-align: top;\n\n}\n\n [quickpaper] header>h2[data-quickpaper-347ecaca]{\n\nfont-size: 16px;\n\npadding-left: 60px;\n\nbackground-image: url('./image/logo.png');\n\nbackground-repeat: no-repeat;\n\nbackground-position: 10px center;\n\nbackground-size: auto 80%;\n\n}\n\n [quickpaper] header>ul[data-quickpaper-347ecaca]{\n\npadding-left: 50px;\n\n}\n\n [quickpaper] header>ul>li[data-quickpaper-347ecaca]{\n\ndisplay: inline-block;\n\nline-height: 1em;\n\npadding: 10px;\n\ncursor: pointer;\n\nmargin: 0 10px;\n\n}\n\n [quickpaper] header>ul>li[active='yes'][data-quickpaper-347ecaca]{\n\nborder-bottom: 1px solid red;\n\n}\n\n [quickpaper] header>.search[data-quickpaper-347ecaca]{\n\nposition: absolute;\n\nright: 10px;\n\n}\n";
styleElement.setAttribute('type', 'text/css');head.appendChild(styleElement);
